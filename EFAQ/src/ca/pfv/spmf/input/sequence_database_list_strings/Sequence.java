...
public class Sequence {
	 ...
	 * 
	 * @param id
	 *            a sequence id that should be unique.
	 */
	 ...
	 */
	public Sequence cloneSequenceMinusItems(Map<String, Set<Integer>> mapSequenceID,
	 ...
	 *         than minsup have been excluded.
	 */
	public List<String> cloneItemsetMinusItems(List<String> itemset,
			Map<String, Set<Integer>> mapSequenceID, double relativeMinsup) {
