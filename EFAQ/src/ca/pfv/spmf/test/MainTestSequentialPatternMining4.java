...
public class MainTestSequentialPatternMining4 {
	...
	public static void main(String[] arg) throws IOException {
		...
		// This options is offered because on some database, AprioriClose does
		// not
		...
		// Apply algorithm
		AlgoFournierViger08 algoPrefixSpanHirateClustering = new AlgoFournierViger08(minsupp, 0,
				Long.MAX_VALUE, 0, Long.MAX_VALUE, null, true, true);
		...
		// NOTE : IF YOU DON'T WANT TO MINE *CLOSED* MD-SEQUENCES, JUST CHANGE
		// THE FOUR VALUES "true" for
