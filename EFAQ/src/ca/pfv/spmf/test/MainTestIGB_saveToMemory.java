...
/**
 * Examples of how to generate the IGB basis of association rules, from the
 * source code, and keep the result into memory.
 * 
...
public class MainTestIGB_saveToMemory {
	...
	public static void main(String[] args) throws IOException {
		...
		Rules rules = algoIGB.runAlgorithm(results, database.getTransactions().size(), minconf,
				output);
