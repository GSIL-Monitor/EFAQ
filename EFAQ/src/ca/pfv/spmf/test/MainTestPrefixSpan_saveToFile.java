...
public class MainTestPrefixSpan_saveToFile {
	...
	public static void main(String[] arg) throws IOException {
		String outputPath = "D:/lab/final/output.txt";
		String inputPath = "tag.txt";
		// Load a sequence database
		SequenceDatabase sequenceDatabase = new SequenceDatabase();
		// sequenceDatabase.loadFile(fileToPath("contextPrefixSpan.txt"));
		sequenceDatabase.loadFile(fileToPath(inputPath));
		...
		int minsup = 10; // we use a minimum support of 2 sequences.
