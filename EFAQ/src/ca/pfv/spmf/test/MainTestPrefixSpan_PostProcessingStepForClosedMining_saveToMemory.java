...
/**
 * Example of how to use the algorithm PrefixSpan but executing a postprocessing
 * step at the end in order to find only the closed frequent patterns. The
 * output is saved in the main memory
 * 
 * @author agomariz
 */
public class MainTestPrefixSpan_PostProcessingStepForClosedMining_saveToMemory {
	...
	public static void main(String[] args) throws IOException {
		...
		AlgoCloSpan algorithm = new AlgoCloSpan(support, abstractionCreator, findClosedPatterns,
