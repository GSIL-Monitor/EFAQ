...
/**
 * Example of how to mine perfectly sporadic association rules with
 * AprioriInverse, from the source code.
 * 
...
public class MainTestAllPerfectlySporadicAssociationRules_Apriori_saveToMemory {
	...
	public static void main(String[] arg) throws IOException {
		...
		String output = null; // null because we want to keep the result into
								// memory instead of save it to a file in this
								// example

		// STEP 1: Applying the APRIORI-Inverse algorithm to find sporadic
		// itemsets
		...
		// STEP 2: Generating all rules from the set of sporadic itemsets (based
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestAllPerfectlySporadicAssociationRules_Apriori_saveToMemory.class
