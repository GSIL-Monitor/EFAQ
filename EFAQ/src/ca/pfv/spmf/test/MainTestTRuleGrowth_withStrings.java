...
/**
 * * Example of how to use the TRULEGROWTH algorithm with strings in source
 * code.
 * 
...
public class MainTestTRuleGrowth_withStrings {
	...
	public static void main(String[] arg) throws IOException {
		String input = fileToPath("contextPrefixSpanStrings.txt"); // the
																	// database
		String output = ".//output.txt"; // the path for saving the frequent
											// itemsets found

		// Applying RuleGROWTH algorithm with minsup = 3 sequences and minconf =
		// 0.5
		double minsup = 0.7;
		double minconf = 0.8;
		int windowSize = 3;
