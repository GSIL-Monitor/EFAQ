...
/**
 * Example of sequential pattern mining with integer values.
 * 
...
public class MainTestSequentialPatternMining3_saveToFile {
	...
	public static void main(String[] arg) throws IOException {
		...
		// we create the clustering algorithm to be used.
		AlgoKMeansWithSupport algoKMeansWithSupport = new AlgoKMeansWithSupport(5, 0.50,
				sequenceDatabase.size(), new AlgoKMeans_forFournier08(5), 1);

		// Create an instance of the algorithm
		AlgoFournierViger08 algo = new AlgoFournierViger08(0.50, 0, Double.MAX_VALUE, 0,
				Double.MAX_VALUE, algoKMeansWithSupport, false, false);
