...
/**
 * Example of how to mine all association rules with CFPGROWTH and use the lift,
 * and save the result to a file, from the source code.
 * 
...
public class MainTestAllAssociationRules_CFPGrowth_saveToFile_withLift {
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestAllAssociationRules_CFPGrowth_saveToFile_withLift.class
