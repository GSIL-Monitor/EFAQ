...
public class MainTestItemsetTree {
	...
	public static void main(String[] arg) throws IOException {
		...
		// It is also possible to add transactions manually. For example, we can
		// add
		...
		// Example query 3: get all itemsets that subsume an itemset and have a
		...
		// Example query 4 : generate all association rules with an itemset as
		// antecedent and minsup and minconf
		System.out
