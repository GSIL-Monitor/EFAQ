...
/**
 * Example of how to use the APRIORI algorithm (hash-tree version), from the
 * source code.
 * 
...
public class MainTestAprioriHT_saveToFile {
	...
	public static void main(String[] arg) throws IOException {
		...
		String output = "frequent_itemsets.txt"; // the path for saving the
													// frequent itemsets found

		double minsup = 0.4; // means a minsup of 2 transaction (we used a
								// relative support)

		// This version of apriori use hash-tree. We need to set the number of
		// child nodes
