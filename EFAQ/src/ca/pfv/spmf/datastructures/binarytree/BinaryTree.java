...
public class BinaryTree<T extends Comparable<T>> {
	...
	public void add(T element) {
		...
		// the place where the new node z should be inserted (as a child of y)
		// so
	...
	public T maximum() {
		...
		// otherwise go down the right links until reaching a leaf and return
		// the key
	...
	public class Node {
		...
		public String toString() {
			...
			// if there is a right subtree, then append the key of the right
			// child
			if (right != null) {
