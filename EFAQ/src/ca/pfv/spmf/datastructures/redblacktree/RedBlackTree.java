...
public class RedBlackTree<T extends Comparable<T>> implements Iterable<T> {
	...
	static final boolean	BLACK							= true;		// define
																			// black
	static final boolean	RED								= false;		// define
																			// red
	final private Node		NULL							= new Node();	// the
																			// sentinel
																			// node
	 ...
	 * 
	 * @param x
	 *            the node where the operation will be performed.
	 */
	...
	/**
	 * Get the successor node of a node (the node having the smallest value
	 * larger than the one of this node).
	 * 
	 * @param x
	 *            a node
	...
	/**
	 * Get the predecessor node of a node (the node having the largest value
	 * smaller than the one of this node).
	 * 
	 * @param x
	 *            a node
