...
public class KDTree {
	...
	private int				nodeCount		= 0;										// number
																						// of
																						// nodes
																						// in
																						// the
																						// tree
	private KDNode			root			= null;									// the
																						// tree
																						// root
	int						dimensionCount	= 0;										// number
																						// of
																						// dimensions
	 ...
	 * 
	 * @param points
	 *            an array of points, where each point is a double[]
	 */
	 ...
	 * time. It is based on the pseudo-code of the Randomized-Select algorithm
	 * in the book "Introduction to algorithms" by Cormen et al. (2001), with
	 * some modifications such as using a while loop instead of recursive calls.
	 * 
	 * @param a
	 *            : array of integers
	 * @param i
	 *            : the rank i of the desired integer.
	 * @param currentD
	...
	double		minDist				= 0;	// the distance of the current
											// nearest neighbor with the target
											// point.
	...
	/**
	 * This method find the node where this point would be inserted in the
	 * kdd-tree.
	 * 
	 * @param target
	 *            : the point
	 ...
	 * @param d
	 *            : the dimension used at this level of the tree.
	...
	RedBlackTree<KNNPoint>	resultKNN	= null; // field to store the current k
												// nearest neighboor with the
												// target point
	...
	public RedBlackTree<KNNPoint> knearest(double[] targetPoint, int k) {
		...
		// First traverse the tree to find the place where the node would be
		// inserted.
	...
	/**
	 * Method to try to save a node in the set of the current closest k
	 * neighbors.
	 * 
	 * @param node
	...
	/**
	 * Start back at the root, and check all rectangles that have a
	 * perpendicular distance smaller than the k best points found until now.
	 * 
	 * @param node
	 *            the current node
	 * @param targetPoint
