...
public class AlgoAprioriTID_forCMRules {
	 ...
	 * Run the algorithm.
	 * 
	 * @param minsuppRelative
	 *            the minimum support threshold
	 * @param listFrequentsSize1
	 *            the list of frequent itemsets of size 1
	 * @param mapItemCount
	 *            a map of items (key) and their tidset (value).
	 ...
	 * 
	 * @param listFrequentsSize1
	 *            list of frequent items of size 1
	 * @param mapItemCount
	...
	protected List<Itemset> createLevelWithFrequentItemsetsSize1(List<Integer> listFrequentsSize1,
		...
		for (Integer item : listFrequentsSize1) {
			...
			// add it to the level k that will be used for generating k+1 later
			// on...
			levelK.add(itemset);
