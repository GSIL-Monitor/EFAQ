 ...
 * are unordered itemsets. The RuleGrowth algorithm is described in this paper: <br/>
 * <br/>
...
public class AlgoRULEGROWTH {
	...
	// The map of occurences associates to sequence ID (key), an occurence of
	// the item (value).
	Map<Integer, Map<Integer, Occurence>>	mapItemCount;		// item, <tid,
																// occurence>
	 ...
	 * 
	 * @param minSupport
	 *            : the minimum support (percentage as a double value)
	 * @param minConfidence
	 *            : the minimum confidence threshold
	 * @param input
	 *            : an input file path of a sequence database
	 * @param output
	 *            : a file path for writing the output file containing the seq.
	 *            rules.
	 * @exception IOException
	 *                if error reading/writing files
	 */
	 ...
	 * The main method to run the algorithm
	 * 
	 * @param relativeMinsup
	 *            : the minimum support as an integer value (a relative minimum
	 *            support)
	 * @param minConfidence
	 *            : the minimum confidence threshold
	 * @param input
	 ...
	 *                if error reading/writing files
	 */
	public void runAlgorithm(String input, String output, int relativeMinsup, double minConfidence)
			throws IOException {
		...
		for (int i = 0; i < listFrequents.size(); i++) {
			...
			for (int j = i + 1; j < listFrequents.size(); j++) {
				...
				// initialize the sets
				Set<Integer> tidsIJ = new HashSet<Integer>(); // tidset of I
																// -->J
	...
	private void expandLeft(int[] itemsetI, int[] itemsetJ, Collection<Integer> tidsI,
			Collection<Integer> tidsIJ, Map<Integer, Occurence> occurencesJ) throws IOException {
