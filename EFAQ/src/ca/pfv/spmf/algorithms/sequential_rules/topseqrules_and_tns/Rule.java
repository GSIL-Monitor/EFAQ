...
public class Rule implements Comparable<Rule> {
	...
	/**
	 * flag indicating if both left and right expansion should be explored from
	 * this rule
	 */
	 ...
	 *            the transaction IDs of the consequent
	 * @param tidsIJ
	 *            transaction IDs of the sequences where the antecedent appears
	 *            before the consequent
	 * @param occurencesIfirst
	 *            maps of first occurences of the antecedent
	 * @param occurencesJlast
	 *            maps of last occurences of the antecedent
	 */
	public Rule(int[] itemset1, int[] itemset2, double confidence, int transactioncount,
			...
			Map<Integer, Short> occurencesIfirst, Map<Integer, Short> occurencesJlast) {
	 ...
	 * 
	 * @param sequencecount
	 *            the number of sequence in the original sequence database
	...
	/**
	 * Check if this rule is equal to another (if they have the same items in
