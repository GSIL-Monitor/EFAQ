...
public class DecisionTree {
	 ...
	 * 
	 * @param newInstance
	 *            an instance for which to perform the prediction.
	 * @return Return the class name or null if the tree cannot predict the
	 *         class, for example because some value does not appear in the
	 *         tree.
	 */
	 ...
	 * 
	 * @param currentNode
	 *            the current node from the decision tree that is considered
	 * @param newInstance
	 *            an instance for which to perform the prediction.
	 * @return Return the class name or null if the tree cannot predict the
	 *         class, for example because some value does not appear in the
	...
	private String predict(Node currentNode, String[] newInstance) {
		...
		return null; // null if no subtree correspond to the attribute value for
						// the instance
	}
