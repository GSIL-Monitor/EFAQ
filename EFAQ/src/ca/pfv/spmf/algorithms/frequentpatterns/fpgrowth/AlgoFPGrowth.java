...
public class AlgoFPGrowth {
	...
	private long			endTime;					// end time of the
														// latest execution
	private int				transactionCount	= 0;	// transaction count in
														// the database
	private int				itemsetCount;				// number of freq.
														// itemsets found

	// parameter
	public int				relativeMinsupp;			// the relative minimum
														// support

	BufferedWriter			writer				= null; // object to write the
														// output file
	...
	private void scanDatabaseToDetermineFrequencyOfSingleItems(String input,
			final Map<Integer, Integer> mapSupport) throws FileNotFoundException, IOException {
	 ...
	 *             exception if error writing the output file
	 */
	private void fpgrowthMoreThanOnePath(FPTree tree, int[] prefixAlpha, int prefixSupport,
			Map<Integer, Integer> mapSupport) throws IOException {
