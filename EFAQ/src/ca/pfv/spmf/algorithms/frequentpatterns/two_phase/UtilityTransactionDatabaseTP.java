...
public class UtilityTransactionDatabaseTP {
	...
	private void processTransaction(String line[]) {
		...
		for (String utility : line[2].split(" ")) {
			// convert the item to an integer and add it to the list of item
			// utilities
	...
	/**
	 * This perform a bubble sort on two lists at the same time (a list of items
	 * in a transaction and a list of corresponding utility values)
	 * 
	 * @param items
	 *            a list of items
	 * @param itemsUtilities
	 *            a corresponding list of utility values
	 */
