...
public class AlgoAprioriTID {
	...
	// variable to store the result if the user choose to save to memory instead
	// of a file
	...
	/**
	 * This method run the algorithm on a transaction database already in
	 * memory.
	 * 
	 * @param database
	 *            the transaction database
	 * @param minsup
	 *            the minimum support threshold as a percentage (double)
	 * @return the method returns frequent itemsets
	 * @throws IOException
	 *             exception if error reading/writing the file
	 */
	 ...
	 * 
	 * @param input
	 *            the file path of an input file. if null, the result is
	...
	public Itemsets runAlgorithm(String input, String output, double minsup)
		...
		if (database != null) {
			...
			for (List<Integer> transaction : database.getTransactions()) { // for
																			// each
																			// transaction
				// for each token (item)
				for (int item : transaction) {
					...
					// add the current transaction id (tid) to the set of the
					// current item
			...
			String line;
			while (((line = reader.readLine()) != null)) { // for each
															// transaction
	...
	/**
	 * Save a frequent itemset to the output file or memory, depending on what
	 * the user chose.
	 * 
	 * @param itemset
	 *            the itemset
	 ...
	 * 
	 * @param emptySetIsRequired
	 *            if true the empty set will be included.
	 */
