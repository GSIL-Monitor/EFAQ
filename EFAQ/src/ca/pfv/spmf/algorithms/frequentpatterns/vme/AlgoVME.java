 ...
 * <br/>
 * 
 * The VME algorithm finds all the ereasable itemsets from a product database.<br/>
 * <br/>
 * 
...
public class AlgoVME {
	 ...
	 * @param output
	 *            path to be used for writing the output file
	 * @param threshold
	...
	public void runAlgorithm(String input, String output, double threshold)
		...
		// and at the same time we record the profit of each transaction
		// (product).
		overallProfit = 0;
		...
		while (((line = reader.readLine()) != null)) {
			...
			// put the profit of this transaction in the map of transaction
			// profit
	 ...
	 *            the loss
	 * @throws IOException
	 *             exception if error while writing to output file
	 */
