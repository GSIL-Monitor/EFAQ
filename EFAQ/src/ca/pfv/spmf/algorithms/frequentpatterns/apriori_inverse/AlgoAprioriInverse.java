...
/**
 * This is an implementation of the AprioriInverse algorithm as described by : <br/>
 * <br/>
 * 
...
public class AlgoAprioriInverse {
	...
	protected int		totalCandidateCount	= 0;	// number of candidate
													// generated during last
													// execution
	protected long		startTimestamp;			// start time of last
													// execution
	protected long		endTimestamp;				// end time of last
													// execution
	private int			itemsetCount;				// itemset found during last
													// execution
	 ...
	 * @param maxsup
	 *            a maximum support value as a percentage
	 * @param input
	 ...
	 * @throws IOException
	 *             exception if error while writing or reading the input/output
	 *             file
	 */
	public Itemsets runAlgorithm(double minsup, double maxsup, String input, String output)
			throws IOException {
		...
		Map<Integer, Integer> mapItemCount = new HashMap<Integer, Integer>(); // to
																				// count
																				// the
																				// support
																				// of
		...
		database = new ArrayList<int[]>(); // the database in memory (intially
											// empty)
		...
		for (Entry<Integer, Integer> entry : mapItemCount.entrySet()) {
			if (entry.getValue() >= minsupRelative && entry.getValue() <= maxsupRelative) { // THE
																							// ONLY
																							// BIG
																							// DIFFERENCE
																							// WITH
	...
	/**
	 * Save an itemset to the file or to memory if no output file path was
	 * provided
	 * 
	 * @param itemset
	 *            the itemset to be saved.
	 * @throws IOException
	...
	/**
	 * Save an itemset of size 1 to the file or to memory if no output file path
	 * was provided
	 * 
	 * @param item
	 *            a single item (an itemset of size 1)
	 * @param support
