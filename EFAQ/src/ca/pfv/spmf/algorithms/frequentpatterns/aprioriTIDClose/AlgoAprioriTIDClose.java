...
public class AlgoAprioriTIDClose {
	 ...
	 * @param outputFile
	 *            an output file path, if the result should be saved otherwise
	 *            leave it null and this method will keep the result into memory
	 *            and return it.
	 ...
	 * 
	 * @param database
	 * @return a map indicating the tidset of each item (key: item value:
	 *         tidset)
	 */
	 ...
	 */
	private void checkIfItemsetsK_1AreClosed(Collection<Itemset> levelKm1, List<Itemset> levelK)
			throws IOException {
