...
/**
 * This class represents an ITNode from the ITSearch Tree used by Charm and
 * Eclat algorithms.<br/>
 * <br/>
 * 
 * @see ITSearchTree
...
class ITNode {
	...
	/**
	 * Method used by Charm to replace all itemsets in the subtree defined by
	 * this node as the itemsets union a replacement itemset.
	 * 
	 * @param replacement
	 *            the replacement itemset
	 */
	 ...
	 * @param brother
	 *            the brother node
	 * @return the resulting tidset of null if it was determined that the
	 *         resulting tidset would have less tids than minsup
	 */
	...
	// return brother.getItemset().itemset.size() ==
	// this.getItemset().itemset.size()
