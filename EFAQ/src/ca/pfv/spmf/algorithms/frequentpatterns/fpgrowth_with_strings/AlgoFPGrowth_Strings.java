...
public class AlgoFPGrowth_Strings {
	...
	// for statistics
	private long	startTimestamp;			// start time of the latest
												// execution
	private long	endTime;					// end time of the latest
												// execution
	private int		transactionCount	= 0;	// transaction count in the
												// database
	private int		itemsetCount;				// number of freq. itemsets
												// found
	...
	private void scanDatabaseToDetermineFrequencyOfSingleItems(String input,
			final Map<String, Integer> mapSupport) throws FileNotFoundException, IOException {
	 ...
	 */
	private void fpgrowth(FPTree_Strings tree, String[] prefixAlpha, int prefixSupport,
	 ...
	 *             exception if error writing the output file
	 */
	private void fpgrowthMoreThanOnePath(FPTree_Strings tree, String[] prefixAlpha,
			int prefixSupport, Map<String, Integer> mapSupport) throws IOException {
	 ...
	 * @throws IOException
	 */
	private void addAllCombinationsForPathAndPrefix(FPNode_Strings node, String[] prefix)
			throws IOException {
