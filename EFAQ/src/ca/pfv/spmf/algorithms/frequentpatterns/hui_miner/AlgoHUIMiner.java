...
public class AlgoHUIMiner {
	...
	long					startTimestamp	= 0;	// the time the algorithm
													// started
	long					endTimestamp	= 0;	// the time the algorithm
													// terminated
	int						huiCount		= 0;	// the number of HUI
													// generated

	Map<Integer, Integer>	mapItemToTWU;

	BufferedWriter			writer			= null; // writer to write the
													// output file
