...
public class BitMatrix {
	...
	private int[]		support1item;	// array to keep the support of each
										// item.
	 ...
	 * 
	 * @param itemCount
	 *            the number of items in the bitmatrix
	 * @param transactionCount
	 *            the number of transactions (number of bits in each bitset)
	 */
	 ...
	 *            the item
	 * @param bit
	 *            the bit corresponding to the tid
	 */
