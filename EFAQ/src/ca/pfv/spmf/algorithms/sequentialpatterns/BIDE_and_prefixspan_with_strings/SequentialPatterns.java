...
public class SequentialPatterns {
	...
	/**
	 * A list of list is used to stored the sequential patterns. // At position
	 * i, a list of sequential patterns contains // all sequential patterns of
	 * size i.
	 */
	private final List<List<SequentialPattern>>	levels			= new ArrayList<List<SequentialPattern>>(); // itemset
																											// class�
																											// par
																											// taille
	 ...
	 * 
	 * @param name
	 *            a name to give to this set of patterns
	 */
	public SequentialPatterns(String name) {
		this.name = name;
		levels.add(new ArrayList<SequentialPattern>()); // on cr�� le niveau
														// z�ro vide par d�faut.
	}
	 ...
	 * 
	 * @param nbObject
	 *            the size of the original database in terms of sequences.
	 */
	 ...
	 * 
	 * @param nbObject
	 *            the number of sequences in the database where these patterns
	 *            were found.
	 * @return a string
	 */
	 ...
	 * @param k
	 *            the size of the sequential pattern in temrs of itemset.
	 */
