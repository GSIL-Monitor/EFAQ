...
class PseudoSequenceBIDE extends PseudoSequence {
	...
	protected List<PseudoSequencePair> getAllInstancesOfPrefix(List<Itemset> prefix, int i) {
		List<List<Position>> listInstances = getAllInstancesOfPrefixHelper(prefix, 0,
				new ArrayList<List<Position>>(), new ArrayList<Position>(), 0);
		...
		for (List<Position> listPositions : listInstances) {
			PseudoSequenceBIDE newSequence = new PseudoSequenceBIDE(this, this.firstItemset,
	...
	protected List<List<Position>> getAllInstancesOfPrefixHelper(List<Itemset> prefix,
			int indexItemset, List<List<Position>> allInstances, List<Position> listPositionsTotal,
			int decalageItemset) {
