...
public class AbstractionCreator_Qualitative extends AbstractionCreator {
	 ...
	 * @param postfix
	 */
	private void addPair(Map<Pair, Pair> pairMap, Set<Pair> alreadyCountedForSequenceID,
			int sequenceId, Item item, boolean postfix) {
		/*
	...
	/**
	 * Method to find all frequent items in a database. This is for k> 1.
	 * 
	 * @param sequences
	 *            the sequences from the database
	...
	/**
	 * Convert a Map<Item, Set<Abstraction_Generic>> to Map<Item,
	 * Set<Abstraction_Generic>>
	 * 
	 * @param sequence
	 *            a sequence (not used)
	 * @param frequentItems
