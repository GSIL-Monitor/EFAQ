...
public final class Itemset {
	 ...
	 * 
	 * @param item
	 *            the item that compose the itemset.
	 * @param timestamp
	 *            the timestamp associated with the itemset.
	 */
	...
	/**
	 * It adds an item to the itemset. The item is inserted in the last
	 * position.
	 * 
	 * @param value
	 *            The item to add
	 ...
	 * 
	 * @param i
	 *            index where we want to add the item
	 * @param value
	 *            The item to add
	 */
	 ...
	 * 
	 * @param index
	 *            The index where is the item in which we are interested.
	 * @return the item
	 */
	 ...
	 * 
	 * @param mapSequenceID
	 *            the map of items with their associated bitsets representing
	 *            their sequence IDs
	 * @return the clone
	 */
	...
	/**
	 * Check if this itemset is equal to another Two itemsets are equals if in
	 * each position they have the same item.
	 * 
	 * @param arg
	 *            the other itemset
