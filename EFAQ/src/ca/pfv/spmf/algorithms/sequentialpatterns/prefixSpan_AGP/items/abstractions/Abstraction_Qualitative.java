...
public class Abstraction_Qualitative extends Abstraction_Generic {
	...
	private static Map<Boolean, Abstraction_Qualitative>	pool	= new HashMap<Boolean, Abstraction_Qualitative>(
																			4);
	...
	/**
	 * Get the string representation of this abstraction. Adjusted to SPMF
	 * format.
	 * 
	 ...
	 * starts in the first item of the itemset and the abstraction does not have
	 * an equal relation.
	 * 
	 * @param sequence
	 *            The sequence in which we apply the method
	 * @param projection
