...
public class Sequence {
	 ...
	 * 
	 * @param indexItemset
	 *            Itemset index where we want to insert the item
	 * @param item
	 *            The item that we want to insert
	 */
	...
	/**
	 * It adds an item in the specified item position of the specified itemset
	 * of the sequence
	 * 
	 * @param indexItemset
	 *            Itemset index where we want to insert the item
	 * @param indexItem
	 *            Item index where we want to insert the item
	 * @param item
	 *            The item that we want to insert
	 */
	 ...
	 * 
	 * @param indexItemset
	 *            Itemset index of itemset that we want to remove
	 ...
	 * 
	 * @param indexItemset
	 *            Itemset index from where we want to remove the item
	 * @param indexItem
	 *            Item index that we want to remove
	 ...
	 * 
	 * @param index
	 *            the itemset index in which we are interested in
	 * @return the itemset
	 */
	 ...
	 * 
	 * @param mapSequenceID
	 *            Association between aun item and their appearances in the
	 *            database
