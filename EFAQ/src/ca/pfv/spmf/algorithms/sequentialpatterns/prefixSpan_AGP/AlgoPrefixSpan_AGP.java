...
/**
 * This is an implementation of the PrefixSpan algorithm by Antonio Gomariz
 * Peñalver(AGP). PrefixSpan was proposed by Pei et al. 2001. This algorithm was
 * inspired in the implementation of SPMF and, from it, I changed and optimized
 * some things. <br/>
 * <br/>
 * 
...
public class AlgoPrefixSpan_AGP {
	 ...
	 * @throws IOException
	 */
	protected void prefixSpan(SequenceDatabase database, boolean keepPatterns, boolean verbose,
			String outputFilePath) throws IOException {
		...
		// of PrefixSpan
		RecursionPrefixSpan_AGP algorithm = new RecursionPrefixSpan_AGP(abstractionCreator, saver,
				(int) minSupAbsolute, pseudoDatabase, mapSequenceID);
