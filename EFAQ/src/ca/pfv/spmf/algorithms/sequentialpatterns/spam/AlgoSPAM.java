...
/***
 * This is an implementation of the SPAM algorithm. <br/>
 * <br/>
 * The SPAM algorithm was originally described in this paper: <br/>
 * <br/>
 * 
 * Jay Ayres, Johannes Gehrke, Tomi Yiu, and Jason Flannick. Sequential PAttern
 * Mining Using Bitmaps. In Proceedings of the Eighth ACM SIGKDD International
 * Conference on Knowledge Discovery and Data Mining. Edmonton, Alberta, Canada,
 * July 2002. <br/>
 * <br/>
 * 
 * I tried to do what is indicated in that paper but some optimizations are not
 * described with enough details in the paper. So my implementation does not
 * include these optimizations for example: - lookup tables for bitmaps -
...
public class AlgoSPAM {
	...
	private void dfsPruning(Prefix prefix, Bitmap prefixBitmap, List<Integer> sn, List<Integer> in,
			int hasToBeGreaterThanForIStep, int m) throws IOException {
