...
/**
 * This class implements a candidate as used by the TKS algorithm for top-k
 * sequential pattern mining. <br/>
 * <br/>
 * 
 * Copyright (c) 2013 Philippe Fournier-Viger <br/>
 * <br/>
 * 
...
public class Candidate implements Comparable<Candidate> {
	...
	public Candidate(Prefix prefix, Bitmap bitmap, Collection<Integer> sn, Collection<Integer> in,
			Integer hasToBeGreaterThanForIStep) {
		this.prefix = prefix;
		this.bitmap = bitmap;
		this.sn = sn;
