...
/**
 * Implementation of a pattern found by the VMSP algorithm. <br/>
 * <br/>
 * 
...
public class PatternVMSP implements Comparable<PatternVMSP> {
	...
	public int compareTo(PatternVMSP o) {
		...
		int compare = o.prefix.sumOfEvenItems + o.prefix.sumOfOddItems - this.prefix.sumOfEvenItems
				- this.prefix.sumOfOddItems;
		if (compare != 0) {
			return compare;
		}
