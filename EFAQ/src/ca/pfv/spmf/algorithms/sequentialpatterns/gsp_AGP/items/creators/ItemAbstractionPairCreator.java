...
public class ItemAbstractionPairCreator {
	...
	public ItemAbstractionPair getItemAbstractionPair(Item item, Abstraction_Generic abstraction) {
		/*
		 * Map<Abstraction_Generic, ItemAbstractionPair> itemPair =
		 * pairPool.get(item);
		 */
		ItemAbstractionPair pair;
		/*
		 * if (itemPair != null) { pair = itemPair.get(abstraction); if (pair ==
		 * null) {
		 */
		 ...
		 * ItemAbstractionPair(item, abstraction); itemPair.put(abstraction,
		 * pair); pairPool.put(item, itemPair); }
		 */
		return pair;
	}
}
