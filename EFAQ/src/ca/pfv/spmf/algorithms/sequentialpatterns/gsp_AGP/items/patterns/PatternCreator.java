...
public class PatternCreator {
	...
	public Pattern createPattern(List<ItemAbstractionPair> elements) {
		...
		/*
		 * Pattern existingPattern = patternPool.get(newPattern); if
		 * (existingPattern == null) { existingPattern = newPattern;
		 * patternPool.put(newPattern, newPattern); } return existingPattern;
		 */
		return newPattern;
	}
