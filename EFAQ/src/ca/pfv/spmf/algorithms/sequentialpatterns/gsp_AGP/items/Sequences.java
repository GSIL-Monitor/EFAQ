...
public class Sequences {
	...
	/**
	 * List of lists, where each list contains the frequent patterns of a
	 * concrete length
	 */
	 ...
	 *            a sequence to add
	 * @param levelIndex
	 *            the level where the sequence must be
	 */
	public void addSequence(Pattern sequence, int levelIndex) {
		// while our maximum level is less than the given one, we keep adding
		// new levels
	 ...
	 * 
	 * @param index
	 *            the frequent sequences of that level
	...
	/**
	 * It gives us the total number of levels. Notice that we discount the level
	 * 0
	 * 
	 ...
	 * sequences with a concrete length For example, at position 1, it is the
	 * list of patterns of size 1. at position 2, it is the list of patterns of
	 * size 2 ... etc.
	 * 
