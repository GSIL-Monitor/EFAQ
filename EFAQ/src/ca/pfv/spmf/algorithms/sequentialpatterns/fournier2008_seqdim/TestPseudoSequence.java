...
public class TestPseudoSequence {
	...
	public static void main(String[] args) {
		...
		System.out.print("  is  ");
		pseudoSequence.getFirstInstanceOfPrefixSequence(prefix,
				prefix.getItemOccurencesTotalCount()).pseudoSequence.print();
		System.out.println();
		...
		System.out.print("  is  ");
		pseudoSequence
				.getLastInstanceOfPrefixSequence(prefix, prefix.getItemOccurencesTotalCount()).pseudoSequence
				.print();
		System.out.println();
		...
		prefix2.print();
		System.out.print("  is  ");
		prefix2.getFirstInstanceOfPrefixSequence(prefix, prefix.getItemOccurencesTotalCount()).pseudoSequence
				.print();
		System.out.println();
		...
		prefix2.print();
		System.out.print("  is  ");
		prefix2.getLastInstanceOfPrefixSequence(prefix, prefix.getItemOccurencesTotalCount()).pseudoSequence
				.print();
		System.out.println();
		...
		prefix3.print();
		System.out.print("  is  ");
		prefix3.getFirstInstanceOfPrefixSequence(prefix, prefix.getItemOccurencesTotalCount()).pseudoSequence
				.print();
		System.out.println();
		...
		prefix3.print();
		System.out.print("  is  ");
		prefix3.getLastInstanceOfPrefixSequence(prefix, prefix.getItemOccurencesTotalCount()).pseudoSequence
				.print();
		System.out.println();
