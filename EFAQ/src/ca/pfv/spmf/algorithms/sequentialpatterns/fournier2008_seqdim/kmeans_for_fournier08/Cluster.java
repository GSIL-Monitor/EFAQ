...
public class Cluster {
	...
	/**
	 * Get the item ID associated to this cluster (for use with the
	 * Fournier-Viger 08 algorithm).
	 * 
	 * @return the item ID
	 */
	...
	/**
	 * Set the set of sequence IDs corresponding to this cluster param
	 * sequenceIDs a set of sequence IDs.
	 */
