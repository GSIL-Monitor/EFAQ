...
public class Itemset {
	 ...
	 * 
	 * @param mapSequenceID
	 *            a map indicating the IDs of sequence (value) containing each
	 *            item (key).
	 * @param relativeMinsup
	 *            a relative minimum support (integer)
	 * @return a new Itemset
	 */
	public Itemset cloneItemSetMinusItems(Map<ItemSimple, Set<Integer>> mapSequenceID,
