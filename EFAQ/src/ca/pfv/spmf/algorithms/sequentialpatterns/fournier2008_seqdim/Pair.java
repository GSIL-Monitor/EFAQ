...
class Pair {
	 ...
	 *            a timestamp
	 * @param prefix
	 *            true if the item was found in an itemset that is a prefix
	 * @param postfix
	 *            true if the item was found in an itemset that is a postfix
	 * @param item
	 *            the item
	 */
	...
	public boolean equals(Object object) {
		...
		if ((paire.timestamp == this.timestamp) && (paire.postfix == this.postfix)
				&& (paire.prefix == this.prefix) && (paire.item.equals(this.item))) {
			return true;
		} // otherwise false
		return false;
	}
