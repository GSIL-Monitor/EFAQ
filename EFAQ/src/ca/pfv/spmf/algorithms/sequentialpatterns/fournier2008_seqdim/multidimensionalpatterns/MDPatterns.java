...
public class MDPatterns {
	...
	/**
	 * a list of list containing the MDPatterns by size For example, the
	 * position i is the list of MD-patterns of size i.
	 */
	private final List<List<MDPattern>>	levels			= new ArrayList<List<MDPattern>>(); // sorted
																							// by
																							// size
	 ...
	 * 
	 * @param name
	 *            a name for the patterns that will be contained in this
	 *            structure (String).
	 */
	 ...
	 * 
	 * @param databaseSize
	 *            the number of MD-patterns in the MD-Pattern database.
	 */
	 ...
	 *            an md-pattern
	 * @param k
	 *            the size of this md-pattern in terms of the number of
	 *            dimensions
	 */
