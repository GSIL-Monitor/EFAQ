...
public class MDPattern {
	...
	/**
	 * a code representing the special value "*" that can be found in
	 * md-patterns
	 */
	 ...
	 * 
	 * @param id
	 *            an ID that should be given to this pattern.
	 */
	...
	/**
	 * Get the relative support of this pattern as a percentage with two
	 * decimals (string)
	 * 
	 * @param databaseSize
	 *            the database size
	...
	/**
	 * This method check if this MD-pattern strictly contains a given
	 * MD-pattern. Note that this method is only good for patterns having the
	 * same size.
	 * 
	 * @param mdpattern2
	 *            the given MD-pattern.
	 * @return Return 1 if this mdpattern STRICTLY contains mdpattern2 *AND HAVE
	 *         THE SAME SUPPORT* Return 2 if this mdpattern is exactly the same
	 *         as mdpattern2 *AND HAVE THE SAME SUPPORT* Return 0 if this
	 *         mdpattern does not contains mdpattern2.
	 */
