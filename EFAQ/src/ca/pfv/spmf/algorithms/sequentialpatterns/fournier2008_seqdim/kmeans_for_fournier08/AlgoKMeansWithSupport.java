...
public class AlgoKMeansWithSupport {
	 ...
	 * 
	 * @param maxK
	 *            the maximum number of cluster to be found
	 * @param relativeMinsup
	 *            a relative minimum support threshold
	 * @param algoKMeans
	 *            an implementation of the regular K-Means
	 * @param numberOfTriesForEachK
	 *            the number of times that K-Means should be executed for each
	 *            value of k.
	 */
	 ...
	 *            value of k.
	 */
	public AlgoKMeansWithSupport(int maxK, double minsup, int transactioncount,
			AlgoKMeans_forFournier08 algoKMeans, int numberOfTriesForEachK) {
		this.maxK = maxK;
	...
	public List<Cluster> runAlgorithm(List<ItemValued> items) {
		...
		// that items are not associated to the last set of clusters that was
		// found.
