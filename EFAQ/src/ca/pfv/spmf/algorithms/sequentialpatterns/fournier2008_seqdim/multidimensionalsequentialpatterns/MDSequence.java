...
public class MDSequence {
	 ...
	 * 
	 * @param id
	 *            the id of the md-sequence
	 * @param mdpattern
	 *            the md-pattern in this md-sequence
	 * @param sequence
	 *            the sequence in this md-sequence
	 */
	 ...
	 *            the support as an integer value (as asequence count).
	 */
	 ...
	 * 
	 * @param sequence2
	 *            the given md-sequence
	 * @return true if it strictly contains the given md-sequence, otherwise
	 *         false.
	 */
