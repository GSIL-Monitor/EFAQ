...
public class Sequences {
	...
	/**
	 * Sequences are organized into levels. In the following list, the position
	 * i (level i) is the list of sequential containing i items.
	 **/
	final List<List<Sequence>>	levels			= new ArrayList<List<Sequence>>();	// itemset
																					// class�
																					// par
																					// taille
	 ...
	 * 
	 * @param name
	 *            a name to be given to this group of sequential patterns
	 */
	 ...
	 * @param k
	 *            the number of items in the seq. pattern
	 */
