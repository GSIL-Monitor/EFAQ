...
/**
 * This is the definition of an equivalence class. Each one is composed by a
 * pattern that its the class identifier and the IdList associated with that
 * pattern. Besides, it also contains all the equivalence class children that
 * are supersequences (by means i-extension or s-extension) of the class
 * identifier. In this way a complete structure of classes can be created from
 * the root class to the longest ones.
 * 
...
public class EquivalenceClass implements Comparable<EquivalenceClass> {
	...
	/**
	 * Pattern that is the identifier of the equivalence class, the main
	 * representant.
	 */
	 ...
	 *            The pattern to be use as the equivalence class identifier
	 */
	 ...
	 *            The pattern to be use as the equivalence class identifier
	 * @param idList
	 *            The idList that is associated to that the argument pattern
	 */
	 ...
	 *            The pattern to be use as the equivalence class identifier
	 * @param classMembers
	 *            The equivalence classes that are to be the members of the
	 *            equivalence class (superpatterns of the pattern given as an
	 *            argument)
	 */
	 ...
	 *            argument)
	 * @param idList
	 *            The IdList associated with the pattern given as an argument
	 */
	public EquivalenceClass(Pattern classIdentifier, List<EquivalenceClass> classMembers,
			IDList idList) {
		this.classIdentifier = classIdentifier;
	 ...
	 * 
	 * @param classMembers
	 *            Set of equivalence classes that are going to be the members
	 */
	 ...
	 * 
	 * @param i
	 *            The index of the member in which we are interested
	...
	public void clear() {
		/*
		 * classMembers.clear(); idList.clear(); classIdentifier.clear();
		 */
		classMembers = null;
		idList = null;
