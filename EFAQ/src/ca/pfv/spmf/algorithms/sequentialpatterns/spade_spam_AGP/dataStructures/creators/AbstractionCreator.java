...
public abstract class AbstractionCreator {
	...
	public abstract List<EquivalenceClass> getFrequentSize2Sequences(List<Sequence> sequences,
			IdListCreator idListCreator);

	public abstract Pattern getSubpattern(Pattern extension, int i);

	public abstract List<EquivalenceClass> getFrequentSize2Sequences(
