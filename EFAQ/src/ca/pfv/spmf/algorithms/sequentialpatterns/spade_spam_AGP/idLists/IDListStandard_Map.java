...
public class IDListStandard_Map implements IDList {
	...
	public IDList join(IDList idList, boolean equals, int minSupport) {
		...
		Map<Integer, List<Integer>> intersection = new HashMap<Integer, List<Integer>>(
				((IDListStandard_Map) idList).getSequenceItemsetEntries().size());
	 ...
	 *            Itemset timestamps of the parameter Idlist
	...
	private List<Integer> laterOperation(Integer sid, List<Integer> transactionAppearancesInSequence) {
		// We get the itemset timestamps for the same sequence for the current
		// IdList
		...
		if (transactionAppearancesInSequenceOfMyIdList == null
				|| transactionAppearancesInSequenceOfMyIdList.isEmpty()) {
			return null;
		}
		// Otherwise we create a new List of itemset where we keep the new
		// entries
	...
	private List<Integer> equalOperation(Integer sid, List<Integer> transactionAppearancesInSequence) {
		...
		if (transactionAppearancesInSequenceOfMyIdList.size() <= transactionAppearancesInSequence
				.size()) {
	...
	public void addAppearance(Integer sequence, Integer timestamp) {
		List<Integer> transactionAppearancesInSequenceOfMyIdList = itemsetSequenceEntries
				.get(sequence);
		if (transactionAppearancesInSequenceOfMyIdList == null) {
