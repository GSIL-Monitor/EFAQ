...
public class IdListCreator_StandardMap implements IdListCreator {
	...
	/**
	 * Get the static instance of the singleton IdList creator based on entries
	 * of arraylists.
	 * 
	 * @return the instance
	 */
	...
	/**
	 * It adds an appearance <sid,tid> to an Idlist having entries of type
	 * "arraylist"
	 */
	@Override
	...
	/**
	 * It adds several appearances in a same sequence <sid,
	 * {tid_1,tid_2,...,tid_n}> to an Idlist having entries of type "arraylist"
	 **/
	@Override
