...
public class AlgoSPAM_AGP {
	 ...
	 *            Flag for debugging purposes
	 */
	protected void runSPAM(SequenceDatabase database, long minSupportAbsolute,
		...
		// patterns
		FrequentPatternEnumeration_SPAM frequentPatternEnumeration = new FrequentPatternEnumeration_SPAM(
