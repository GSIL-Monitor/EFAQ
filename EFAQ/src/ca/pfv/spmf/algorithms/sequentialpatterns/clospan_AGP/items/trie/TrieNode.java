...
public class TrieNode implements Comparable {
	 ...
	 * 
	 * @param pair
	 *            ItemAbstractionPair to insert in the node
	 */
	...
	/**
	 * It updates the Trie component of the TrieNode by the Trie given as
	 * parameter
	 * 
	 * @param child
	 *            Trie to insert in the node
	...
	/**
	 * Update the ItemAbstractionPair component of the TrieNode by the pair
	 * given as parameter
	 * 
	 * @param par
	 *            the pair to be inserted in the node
	 */
	 ...
	 * 
	 * @param o
	 *            another TrieNode or ItemAbstractionPair
	...
	/**
	 * It updates the flag that indicates if the NodeTrie has already been
	 * traversed
	 * 
	 * @param alreadyExplored
	 *            the value (true/false) to be set
	 */
