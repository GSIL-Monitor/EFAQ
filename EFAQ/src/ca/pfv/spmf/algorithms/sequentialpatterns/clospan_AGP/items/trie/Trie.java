...
public class Trie implements Comparable<Trie> {
	 ...
	 * 
	 * @param nodes
	 *            the list of nodes to be used for updating
	 */
	 ...
	 * @param index
	 *            Child index in which we are interested
	 * @return true if the node was removed, otherwise, the index was out of
	 *         range and no node was removed.
	 */
	public boolean remove(int index) {
		// if there are some nodes and the index is not within the range of
		// nodes
	 ...
	 * (nodes == null) { nodes = new ArrayList<TrieNode>(1); }
	 * nodes.add(newTrie); } else { nodes.add(newTrie); } }
	 */
			...
			for (TrieNode node : nodes) {
				...
				if (child != null) {
					...
					if (patternsFromChild != null) {
						// If we find some descendants, we add them to the
						// result list
