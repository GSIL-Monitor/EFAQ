...
public class Pattern implements Comparable<Pattern> {
	 ...
	 * belong to the same equivalence class we only make the comparison of the
	 * last items of both patterns.
	 * 
	 * @param o
	 *            the other pattern
	 ...
	 * @param p
	 *            pattern to check if it is a superpattern of the current one
