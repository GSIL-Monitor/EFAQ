...
public class AbstractionCreator_Qualitative extends AbstractionCreator {
	 ...
	 * pattern ,the item specified in the position pointed out by the given
	 * index
	 * 
	 * @param extension
	 *            the pattern
		...
		for (int i = 0; i < extension.size(); i++) {
			if (i != index) {
				...
				if (index == 0) {
					...
					Abstraction_Qualitative abstraccionDelQuitado = (Abstraction_Qualitative) extension
