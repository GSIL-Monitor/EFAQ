...
public class ItemAbstractionPair implements Comparable<ItemAbstractionPair> {
	...
	public boolean equals(Object o) {
		...
		return (this.getItem().equals(pItemAbs.getItem()) && this.getAbstraction().equals(
				pItemAbs.getAbstraction()));
	}
	...
	/**
	 * Get the string representation of this object for saving to file. Adjusted
	 * to SPMF format.
	 * 
