...
public interface IdListCreator {
	...
	/**
	 * Add several appearances in a same sequence <sid, {tid_1,tid_2,...,tid_n}>
	 * to an Idlist
	 */
	...
	public void initializeMaps(Map<Item, TrieNode> frequentItems,
			Map<Item, Map<Integer, List<Integer>>> projectingDistanceMap,
			Map<Integer, Integer> sequenceSize, Map<Integer, List<Integer>> itemsetSequenceSize);

	public void updateProjectionDistance(
			Map<Item, Map<Integer, List<Integer>>> projectingDistanceMap, Item item, int id,
			int size, int i);
}
