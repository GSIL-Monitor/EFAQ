...
public class PatternCreator {
	...
	/**
	 * It creates a pattern from a list of pairs of the form <abstraction,
	 * item>.
	 * 
	 * @param elements
	 *            a list of pairs
	 ...
	 * 
	 * @param pair
	 *            the pair to be used to create the pattern
	 * @return the resulting pattern
	 */
	 ...
	 * 
	 * @param p1
	 *            pattern where the pair has to be concatenated
	 * @param pair
	 *            pair to concatenate with the pattern given as parameter
	 * @return the resulting pattern
	 */
