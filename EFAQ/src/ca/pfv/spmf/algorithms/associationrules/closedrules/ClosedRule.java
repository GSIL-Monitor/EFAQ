...
/**
 * This class represent an association rule used by Szathmary algorithm for
 * closed association rule mining. An association rule is defined by two
 * itemsets and it has a support and a confidence.
 * 
 * The notion of closed association rules was introduced in the thesis of L.
 * Szathmary, 2006.
 * 
 * @see AlgoClosedRules
...
public class ClosedRule {
	 ...
	 * 
	 * @param itemset1
	 *            an itemset that is the left side of the rule
	 * @param itemset2
	 *            an itemset that is the right side of the rule
	 * @param transactionCount
	 *            the support of the rule (integer)
	 * @param confidence
