 ...
 * of the largest item ids and the total number of transactions in the database. <br/>
 * <br/>
 * 
...
public class Database {
	...
	public void loadFile(String path) throws IOException {
		...
		try {
			...
			// for each line (transaction into the file until the end of the
			// file
			String thisLine;
	 ...
	 * 
	 * @param itemsString
	 *            an array of items, where an item is an integer represented as
	 *            a String.
	 */
