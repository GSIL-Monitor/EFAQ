...
public class RuleG implements Comparable<RuleG> {
	...
	public int			maxLeft;				// maximum item id in the
												// antecedent
	public int			maxRight;				// maximum item id in the
												// consequent
	 ...
	 */
	public RuleG(Integer[] itemset1, Integer[] itemset2, int count, BitSet tids1, BitSet common,
