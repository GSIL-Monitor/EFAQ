...
public class AlgoKMeans {
	...
	// For statistics
	private long				startTimestamp;										// the
																						// start
																						// time
																						// of
																						// the
	...
	private long				endTimestamp;											// the
																						...
																						// latest
																						// execution
	private long				iterationCount;										// the
																						// number
																						// of
																						// iterations
																						// that
	 ...
	 */
	public List<Cluster> runAlgorithm(String inputFile, int k) throws NumberFormatException,
			IOException {
