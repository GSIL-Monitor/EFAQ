 ...
 * http://home.dei.polimi.it/matteucc/Clustering/tutorial_html/hierarchical.html <br/>
 * <br/>
 * 
...
public class AlgoHierarchicalClustering {
	...
	// parameter
	private double	maxDistance	= 0;	// maximum distance allowed for merging
										// two clusters
	 ...
	 * 
	 * @param inputFile
	 *            an input file containing vectors of doubles
	 * @param maxDistance
	 *            the maximum distance allowed for merging two clusters
	 * @return a list of Clusters
	 * @throws IOException
	 *             exception if error while reading the file
	 */
	public List<Cluster> runAlgorithm(String inputFile, double maxDistance)
	...
	private boolean mergeTheClosestCluster() {
		...
		for (int i = 0; i < clusters.size(); i++) {
			for (int j = i + 1; j < clusters.size(); j++) {
				...
				double distance = euclideanDistance(clusters.get(i).getmean(), clusters.get(j)
						.getmean());
