...
/**
 * This class represents an itemset (a set of items) where the itemset is a set
 * of integers sorted by lexical order where no item can appear twice and the
 * number of transactions/sequences containing this itemset is represented by an
 * integer.
 * 
