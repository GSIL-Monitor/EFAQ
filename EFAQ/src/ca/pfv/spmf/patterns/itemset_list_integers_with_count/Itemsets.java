...
/**
 * This class represents a set of itemsets that are ordered by size (level) and
 * where an itemset is a list of integers with a support count. For example,
 * level 1 means itemsets of size 1 (that contains 1 item).
 * 
 * @see Itemset
...
public class Itemsets {
	 ...
	 * 
	 * @param nbObject
	 *            The number of transaction/sequence in the database where there
	 *            itemsets were found.
	 */
	public void printItemsets(int nbObject) {
		...
		for (List<Itemset> level : levels) {
			...
			for (Itemset itemset : level) {
				...
				System.out.print("support :  " + itemset.get(nbObject));
				patternCount++;
				System.out.println("");
			}
			levelCount++;
	 ...
	 *            the itemset
	 * @param k
	 *            the number of items contained in the itemset
	 */
	 ...
	 * Get all itemsets.
	 * 
	 * @return A list of list of itemsets. Position i in this list is the list
	 *         of itemsets of size i.
	 */
