...
/**
 * This class represent an hash table for storing itemsets, where an itemset is
 * a list of integers with a tid set represented as a list of integers. It is
 * not currently used in SPMF.
 * 
...
public class HashTable {
	 ...
	 * 
	 * @param size
	 *            the initial size of the internal array for the hash table
	 */
	...
	/**
	 * Method to check if there exists a superset of a given itemset in this
	 * hashtable
	 * 
	 * @param itemset
	 *            the itemset
