...
/**
 * This class represents an itemset as a list of integers with a transaction id
 * set represented by a list of integer.
 * 
 * @see Itemsets
...
public class Itemset extends AbstractMutableOrderedItemset {
	 ...
	 * 
	 * @param listTransactionIds
	 *            the list of transaction/sequence ids
	 */
