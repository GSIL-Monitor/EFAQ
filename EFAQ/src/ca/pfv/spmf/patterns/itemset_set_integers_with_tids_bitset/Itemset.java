...
/**
 * This class represents an itemset such that (1) the itemset is a set of
 * integers, (2) the transactions/sequences ids (tids) containing this itemset
 * are represented with a bitset.
 * 
 * @see Itemsets
 * @see AbstractItemset
