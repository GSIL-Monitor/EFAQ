...
/**
 * This is an abstract class indicating general methods that an itemset should
 * have no matter how it is implemented, and is designed for ordered mutable
...
public abstract class AbstractMutableOrderedItemset extends AbstractOrderedItemset {
	...
	/**
	 * Make a copy of this itemset except that any item of a given itemset are
	 ...
	 * @return the copy
	 */
	public AbstractMutableOrderedItemset cloneItemSetMinusAnItemset(
			AbstractMutableOrderedItemset itemsetToNotKeep) {
