...
/**
 * This class represents an itemset implemented as a set of integers where the
 * transactions/sequences ids (tids) containing this itemset are represented
...
public class Itemset extends AbstractItemset {
	 ...
	 * 
	 * @param nbObject
	 *            the number of transactions/sequences in the database where the
	 *            itemset was found
	...
	/**
	 * This class returns a new itemset that is the union of this itemset and
	 * another given itemset.
	 * 
	 * @param itemset
	 *            a given itemset.
	 * @return the union.
