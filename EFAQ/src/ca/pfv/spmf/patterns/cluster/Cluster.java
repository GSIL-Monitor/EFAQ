...
public class Cluster {
	...
	private List<DoubleArray>	vectors;	// the vectors contained in this
											// cluster
	private DoubleArray			mean;		// the mean of the vectors in this
											// cluster

	private DoubleArray			sum;		// the sum of all vectors in this
											// clusters
	 ...
	 * 
	 * @param vectorsSize
	 *            the size of the vectors to be stored in this cluster
	 */
	 ...
	 * 
	 * @param mean
	 *            A vector of double that will be set as the mean of this
	 *            cluster.
	 */
	 ...
	 * 
	 * @param vector
	 *            The vector of doubles to be added.
	 */
	...
	/**
	 * This method is called by clustering algorithms to recompute the mean of
	 * the cluster.
	 */
	...
	/**
	 * Method to remove a vector from this cluster and update the internal sum
	 * of vectors at the same time.
	 * 
	 * @param vector
