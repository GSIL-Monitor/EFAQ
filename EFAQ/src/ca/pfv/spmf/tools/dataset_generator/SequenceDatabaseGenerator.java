...
public class SequenceDatabaseGenerator {
	...
	/**
	 * This method randomly generates a sequence database according to
	 * parameters provided.
	 * 
	 * @param sequenceCount
	 ...
	 * @param itemCountByItemset
	 *            the number of items by itemset
	 * @param itemsetCountBySequence
	 *            the number of itemsets by sequence
	 * @param output
	 *            the file path for writting the generated database
	 * @param withTimestamps
	 *            if true, this database will contain timestamps, otherwise not
	 * @throws IOException
	 */
	public void generateDatabase(int sequenceCount, int maxDistinctItems, int itemCountByItemset,
		...
		for (int i = 0; i < sequenceCount; i++) {
			...
			for (int j = 0; j < itemsetCountBySequence; j++) {
				...
				// create an arraylist to store items from the itemset that will
				// be generated
