...
public class TransactionDatabaseGenerator {
	...
	/**
	 * This method randomly generates a transaction database according to
	 * parameters provided.
	 * 
	 * @param transactionCount
	 *            transaction count the number of transactions required
	 * @param maxDistinctItems
	 *            the maximum number of distinct items
	 * @param maxItemCountPerTransaction
	 *            the maximum number of items per transaction
	 * @param output
	 *            the file path for writting the generated database
	 * @throws IOException
	 */
	public void generateDatabase(int transactionCount, int maxDistinctItems,
			int maxItemCountPerTransaction, String output) throws IOException {
		...
		for (int i = 0; i < transactionCount; i++) {
			...
			// create an arraylist to store items from the itemset that will be
			// generated
