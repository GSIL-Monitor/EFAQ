 ...
 *                        1 2 3 4
 *                        5" represents the data instance with the value "
 *                        average " for the attribute "
 *                        height", the value "light" for the attribute "
 *                        weight", the value "
 *                        no" for the attribute "lotion", the value "
 *                        burned" for the attribute "burned" and the value 1"
 *                        for the attribute "col_17".
 * 
...
class MainTestConvertTransactionDatabaseARFFtoSPMF {
	...
	public static void main(String[] arg) throws IOException {
		...
		String inputFile = fileToPath("example.arff"); // the file to be
														// converted in ARFF
														// format
		String outputFile = ".//output.txt"; // the resulting converted file in
												// SPMF format
		Formats inputFileformat = Formats.ARFF; // the format of the input file
												// (ARFF)
		int transactionCount = Integer.MAX_VALUE; // the number of transaction
													// from the input file to be
													// converted

		// Create a converter
		TransactionDatabaseConverter converter = new TransactionDatabaseConverter();
		// Call the method to convert the input file from ARFF to the SPMF
		// format
