package com.easily.util
{
    ...
    public class MyDataBase extends EventDispatcher
    {
        private var mDataBase:DataBaseData;
        private var mConnection:Connection;
        public function MyDataBase(database:DataBaseData)
        {
            mDataBase = database;
        }
        public function connect():void
        {
            mConnection = new Connection(mDataBase.host, mDataBase.port, mDataBase.username, mDataBase.password, mDataBase.database);
